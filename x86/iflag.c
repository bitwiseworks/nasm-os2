...
const iflag_t insns_flags[242] = {
    ...
    /*   99 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000002),UINT32_C(0x00000000),UINT32_C(0x00010010) }},
    ...
    /*  106 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00004000),UINT32_C(0x00010010) }},
    /*  107 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00020040) }},
    /*  108 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000001),UINT32_C(0x00000000),UINT32_C(0x00000040) }},
    /*  109 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000001),UINT32_C(0x00000000),UINT32_C(0x00020040) }},
    ...
    /*  145 */ {{ UINT32_C(0x00002004),UINT32_C(0x00008020),UINT32_C(0x00000000),UINT32_C(0x00000400) }},
    /*  146 */ {{ UINT32_C(0x00002006),UINT32_C(0x00008000),UINT32_C(0x00000000),UINT32_C(0x00000100) }},
    /*  147 */ {{ UINT32_C(0x00001004),UINT32_C(0x00008000),UINT32_C(0x00000000),UINT32_C(0x00000100) }},
    /*  148 */ {{ UINT32_C(0x00001020),UINT32_C(0x00008000),UINT32_C(0x00000000),UINT32_C(0x00000100) }},
    /*  149 */ {{ UINT32_C(0x00001020),UINT32_C(0x00008020),UINT32_C(0x00000000),UINT32_C(0x00000400) }},
    /*  150 */ {{ UINT32_C(0x00001010),UINT32_C(0x00008000),UINT32_C(0x00000000),UINT32_C(0x00000100) }},
    /*  151 */ {{ UINT32_C(0x00002005),UINT32_C(0x00008000),UINT32_C(0x00000000),UINT32_C(0x00000100) }},
    /*  152 */ {{ UINT32_C(0x00000040),UINT32_C(0x00010000),UINT32_C(0x00000000),UINT32_C(0x00000200) }},
    /*  153 */ {{ UINT32_C(0x00000000),UINT32_C(0x00010000),UINT32_C(0x00000000),UINT32_C(0x00000200) }},
    /*  154 */ {{ UINT32_C(0x00000000),UINT32_C(0x00020000),UINT32_C(0x00000000),UINT32_C(0x00020000) }},
    /*  155 */ {{ UINT32_C(0x00000000),UINT32_C(0x00020000),UINT32_C(0x00000000),UINT32_C(0x00000000) }},
    /*  156 */ {{ UINT32_C(0x00000010),UINT32_C(0x00020010),UINT32_C(0x00000000),UINT32_C(0x00000000) }},
    /*  157 */ {{ UINT32_C(0x00000020),UINT32_C(0x00020020),UINT32_C(0x00000000),UINT32_C(0x00000400) }},
    /*  158 */ {{ UINT32_C(0x00000040),UINT32_C(0x00020010),UINT32_C(0x00000000),UINT32_C(0x00000000) }},
    /*  159 */ {{ UINT32_C(0x00000040),UINT32_C(0x00020020),UINT32_C(0x00000000),UINT32_C(0x00000000) }},
    /*  160 */ {{ UINT32_C(0x00000020),UINT32_C(0x00041000),UINT32_C(0x00000000),UINT32_C(0x00000000) }},
    /*  161 */ {{ UINT32_C(0x00000000),UINT32_C(0x00040000),UINT32_C(0x00000000),UINT32_C(0x00000000) }},
    /*  162 */ {{ UINT32_C(0x00000000),UINT32_C(0x00080000),UINT32_C(0x00000000),UINT32_C(0x00020000) }},
    /*  163 */ {{ UINT32_C(0x00000020),UINT32_C(0x00080000),UINT32_C(0x00000000),UINT32_C(0x00020000) }},
    /*  164 */ {{ UINT32_C(0x00000010),UINT32_C(0x00080000),UINT32_C(0x00000000),UINT32_C(0x00020000) }},
    /*  165 */ {{ UINT32_C(0x00000000),UINT32_C(0x00100000),UINT32_C(0x00000000),UINT32_C(0x00000000) }},
    /*  166 */ {{ UINT32_C(0x00000000),UINT32_C(0x00100020),UINT32_C(0x00000000),UINT32_C(0x00000400) }},
    /*  167 */ {{ UINT32_C(0x00000010),UINT32_C(0x00100000),UINT32_C(0x00000000),UINT32_C(0x00000000) }},
    /*  168 */ {{ UINT32_C(0x00002004),UINT32_C(0x00100000),UINT32_C(0x00000000),UINT32_C(0x00000000) }},
    /*  169 */ {{ UINT32_C(0x00002004),UINT32_C(0x00100020),UINT32_C(0x00000000),UINT32_C(0x00000400) }},
    /*  170 */ {{ UINT32_C(0x00000020),UINT32_C(0x00100000),UINT32_C(0x00000000),UINT32_C(0x00000000) }},
    /*  171 */ {{ UINT32_C(0x00000008),UINT32_C(0x00100000),UINT32_C(0x00000000),UINT32_C(0x00000000) }},
    /*  172 */ {{ UINT32_C(0x00000000),UINT32_C(0x00200000),UINT32_C(0x00000000),UINT32_C(0x00000000) }},
    /*  173 */ {{ UINT32_C(0x00000000),UINT32_C(0x00200020),UINT32_C(0x00000000),UINT32_C(0x00000400) }},
    /*  174 */ {{ UINT32_C(0x00000008),UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00000800) }},
    /*  175 */ {{ UINT32_C(0x00000010),UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00000800) }},
    /*  176 */ {{ UINT32_C(0x00000020),UINT32_C(0x00000020),UINT32_C(0x00000000),UINT32_C(0x00000c00) }},
    /*  177 */ {{ UINT32_C(0x00000020),UINT32_C(0x00002000),UINT32_C(0x00000000),UINT32_C(0x00010020) }},
    /*  178 */ {{ UINT32_C(0x00000001),UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00000800) }},
    /*  179 */ {{ UINT32_C(0x00000000),UINT32_C(0x00004000),UINT32_C(0x00000000),UINT32_C(0x00001000) }},
    /*  180 */ {{ UINT32_C(0x00000000),UINT32_C(0x00800000),UINT32_C(0x00008000),UINT32_C(0x00002000) }},
    /*  181 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00009000),UINT32_C(0x00004000) }},
    /*  182 */ {{ UINT32_C(0x00000000),UINT32_C(0x80000000),UINT32_C(0x00011040),UINT32_C(0x00004000) }},
    /*  183 */ {{ UINT32_C(0x00000000),UINT32_C(0x80000000),UINT32_C(0x00011000),UINT32_C(0x00004000) }},
    /*  184 */ {{ UINT32_C(0x00000040),UINT32_C(0x00800000),UINT32_C(0x00008000),UINT32_C(0x00002000) }},
    /*  185 */ {{ UINT32_C(0x00000080),UINT32_C(0x00800000),UINT32_C(0x00008000),UINT32_C(0x00002000) }},
    /*  186 */ {{ UINT32_C(0x00000000),UINT32_C(0x00800020),UINT32_C(0x00008000),UINT32_C(0x00002000) }},
    /*  187 */ {{ UINT32_C(0x00000010),UINT32_C(0x00800000),UINT32_C(0x00008000),UINT32_C(0x00002000) }},
    /*  188 */ {{ UINT32_C(0x00000020),UINT32_C(0x00800020),UINT32_C(0x00008000),UINT32_C(0x00002000) }},
    /*  189 */ {{ UINT32_C(0x00000020),UINT32_C(0x00800000),UINT32_C(0x00008000),UINT32_C(0x00002000) }},
    /*  190 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x0000a000),UINT32_C(0x00004000) }},
    /*  191 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00012040),UINT32_C(0x00004000) }},
    /*  192 */ {{ UINT32_C(0x00000000),UINT32_C(0x80000000),UINT32_C(0x00012000),UINT32_C(0x00004000) }},
    /*  193 */ {{ UINT32_C(0x00000000),UINT32_C(0x02000000),UINT32_C(0x00008000),UINT32_C(0x00004000) }},
    /*  194 */ {{ UINT32_C(0x00000000),UINT32_C(0x00800000),UINT32_C(0x00008000),UINT32_C(0x00004000) }},
    /*  195 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000001),UINT32_C(0x00000000),UINT32_C(0x00004000) }},
    /*  196 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00008000),UINT32_C(0x00020008) }},
    /*  197 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000020),UINT32_C(0x00008000),UINT32_C(0x00020400) }},
    /*  198 */ {{ UINT32_C(0x00000000),UINT32_C(0x00400000),UINT32_C(0x00008000),UINT32_C(0x00020000) }},
    /*  199 */ {{ UINT32_C(0x00000000),UINT32_C(0x01000000),UINT32_C(0x00008000),UINT32_C(0x00004000) }},
    /*  200 */ {{ UINT32_C(0x00000000),UINT32_C(0x20000000),UINT32_C(0x00000000),UINT32_C(0x00004000) }},
    /*  201 */ {{ UINT32_C(0x00000000),UINT32_C(0x20000010),UINT32_C(0x00000000),UINT32_C(0x00004000) }},
    /*  202 */ {{ UINT32_C(0x00000000),UINT32_C(0x20000020),UINT32_C(0x00000000),UINT32_C(0x00004000) }},
    /*  203 */ {{ UINT32_C(0x00000000),UINT32_C(0x20000400),UINT32_C(0x00000000),UINT32_C(0x00004000) }},
    /*  204 */ {{ UINT32_C(0x00000000),UINT32_C(0x04000000),UINT32_C(0x00008000),UINT32_C(0x00004000) }},
    /*  205 */ {{ UINT32_C(0x00000000),UINT32_C(0x04000020),UINT32_C(0x00008000),UINT32_C(0x00004000) }},
    /*  206 */ {{ UINT32_C(0x00000000),UINT32_C(0x10000000),UINT32_C(0x00008000),UINT32_C(0x00004000) }},
    /*  207 */ {{ UINT32_C(0x00000000),UINT32_C(0x10000020),UINT32_C(0x00008000),UINT32_C(0x00004000) }},
    /*  208 */ {{ UINT32_C(0x00000000),UINT32_C(0x08000000),UINT32_C(0x00008000),UINT32_C(0x00004000) }},
    /*  209 */ {{ UINT32_C(0x00000000),UINT32_C(0x08000020),UINT32_C(0x00008000),UINT32_C(0x00004000) }},
    /*  210 */ {{ UINT32_C(0x00000000),UINT32_C(0x04000000),UINT32_C(0x00000000),UINT32_C(0x00004000) }},
    /*  211 */ {{ UINT32_C(0x00000000),UINT32_C(0x04000020),UINT32_C(0x00000000),UINT32_C(0x00004000) }},
    /*  212 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00000020),UINT32_C(0x00004000) }},
    /*  213 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000080),UINT32_C(0x00000008),UINT32_C(0x00004000) }},
    /*  214 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00000008),UINT32_C(0x00004000) }},
    /*  215 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000010),UINT32_C(0x00000008),UINT32_C(0x00004000) }},
    /*  216 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000020),UINT32_C(0x00000008),UINT32_C(0x00004000) }},
    /*  217 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000090),UINT32_C(0x00000008),UINT32_C(0x00004000) }},
    /*  218 */ {{ UINT32_C(0x00000000),UINT32_C(0x000000a0),UINT32_C(0x00000008),UINT32_C(0x00004000) }},
    /*  219 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00000010),UINT32_C(0x00004000) }},
    /*  220 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00008000),UINT32_C(0x00004000) }},
    /*  221 */ {{ UINT32_C(0x00000000),UINT32_C(0x80000000),UINT32_C(0x00010040),UINT32_C(0x00004000) }},
    /*  222 */ {{ UINT32_C(0x00000000),UINT32_C(0x80000000),UINT32_C(0x00010000),UINT32_C(0x00004000) }},
    /*  223 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x000100c0),UINT32_C(0x00004000) }},
    /*  224 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00010080),UINT32_C(0x00004000) }},
    /*  225 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00010140),UINT32_C(0x00004000) }},
    /*  226 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00010100),UINT32_C(0x00004000) }},
    /*  227 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00010002),UINT32_C(0x00004000) }},
    /*  228 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00010004),UINT32_C(0x00004000) }},
    /*  229 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00010041),UINT32_C(0x00004000) }},
    /*  230 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00010001),UINT32_C(0x00004000) }},
    /*  231 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00010440),UINT32_C(0x00004000) }},
    /*  232 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00010400),UINT32_C(0x00004000) }},
    /*  233 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00010240),UINT32_C(0x00004000) }},
    /*  234 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00010200),UINT32_C(0x00004000) }},
    /*  235 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000020),UINT32_C(0x00000000),UINT32_C(0x00004400) }},
    /*  236 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000010),UINT32_C(0x00000000),UINT32_C(0x00004000) }},
    /*  237 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000220),UINT32_C(0x00000000),UINT32_C(0x00004400) }},
    /*  238 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000200),UINT32_C(0x00004000),UINT32_C(0x00004000) }},
    /*  239 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00000000),UINT32_C(0x00024000) }},
    /*  240 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000200),UINT32_C(0x00000000),UINT32_C(0x00000040) }},
    /*  241 */ {{ UINT32_C(0x00000000),UINT32_C(0x00000220),UINT32_C(0x00000000),UINT32_C(0x00000400) }},
};
